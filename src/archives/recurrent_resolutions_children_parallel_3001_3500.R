...
resolution_data_fulltext_subset  <- resolution_data_fulltext[3001:3500, ]
...
saveRDS(resolution_data_fulltext_subset, file = "./data/resolution_data_fulltext_recurrent_child_3001_3500.rds")
temp <- readRDS(file='./data/resolution_data_fulltext_recurrent_child_3001_3500.rds')
