...
resolution_data_fulltext_subset  <- resolution_data_fulltext[1:2000, ]
...
# storing created data set into an appropriate rds-file
resolution_data_fulltext_subset_1_1000 <- resolution_data_fulltext_subset

# saving a permanent version of the dataset
saveRDS(resolution_data_fulltext_second_classification, file = "./data/resolution_data_fulltext_second_classification.rds")
temp <- readRDS(file='./data/resolution_data_fulltext_second_classification.rds')
