...
ind
length(ind) # 39 resolutions have empty space
...
# # saving extended resolution_data as rds-file
 saveRDS(resolution_data_fulltext, "ResolutionFullText_cross_refs_alphanum.rds")
