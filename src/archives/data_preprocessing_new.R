...
## we will work with 2/3 of the data for the 
...
nbr_docs <- length(temp)

# getting total number of documents
nbr_docs <- nrow(resolution_data_fulltext)
...
corpus_res <- Reduce(cbind, df_list)
...
id <- paste0(rep("d_", nbr_docs), 1:nbr_docs)
